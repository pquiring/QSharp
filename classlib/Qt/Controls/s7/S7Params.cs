...
public class S7Params {
    ...
    //funcs
    public const byte READ = 0x04;
    public const byte WRITE = 0x05;
    public const byte CONNECT = (byte)0xf0;
    ...
    //transport types
    private const byte TT_UNKNOWN = 0;
    private const byte TT_BIT = 3;
    private const byte TT_UINT = 4;
    private const byte TT_SINT = 5;
    //6
    private const byte TT_REAL = 7;
    //8
    private const byte TT_CHAR = 9;
    ...
    public bool read(byte[] data, int offset, S7Data outData) {
        func = data[offset++];
