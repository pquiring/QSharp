...
public class COTP {
    ...
    public const byte type_data = (byte)0xf0;
    public const byte type_connect = (byte)0xe0;
    public const byte type_connect_ack = (byte)0xd0;
    ...
    public COTP(byte type) {
        ...
        switch (type) {
            ...
            case type_connect:
                ...
                break;
            default:
                Console.WriteLine("Error:Unknown COTP type!!!");
                break;
        }
    }
    private ThreadLock tlock = new ThreadLock();
    private short get_next_id() {
        lock(tlock) {
            return next_id++;
        }
    }
