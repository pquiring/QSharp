...
namespace Qt.Gui {
    [CPPOmitFields]  //GL/gl.h will have these already
    public class OpenGLConstants {
        public static int GL_VERSION_1_1 = 1;
        ...
        public static int GL_ALL_ATTRIB_BITS = 0x000fffff;
        ...
        public static int GL_EXT_vertex_array = 1;
        public static int GL_EXT_bgra = 1;
        public static int GL_EXT_paletted_texture = 1;
        public static int GL_WIN_swap_hint = 1;
        public static int GL_WIN_draw_range_elements = 1;

        public static int GL_VERTEX_ARRAY_EXT = 0x8074;
        public static int GL_NORMAL_ARRAY_EXT = 0x8075;
        public static int GL_COLOR_ARRAY_EXT = 0x8076;
        public static int GL_INDEX_ARRAY_EXT = 0x8077;
        public static int GL_TEXTURE_COORD_ARRAY_EXT = 0x8078;
        public static int GL_EDGE_FLAG_ARRAY_EXT = 0x8079;
        public static int GL_VERTEX_ARRAY_SIZE_EXT = 0x807A;
        public static int GL_VERTEX_ARRAY_TYPE_EXT = 0x807B;
        public static int GL_VERTEX_ARRAY_STRIDE_EXT = 0x807C;
        public static int GL_VERTEX_ARRAY_COUNT_EXT = 0x807D;
        public static int GL_NORMAL_ARRAY_TYPE_EXT = 0x807E;
        public static int GL_NORMAL_ARRAY_STRIDE_EXT = 0x807F;
        public static int GL_NORMAL_ARRAY_COUNT_EXT = 0x8080;
        public static int GL_COLOR_ARRAY_SIZE_EXT = 0x8081;
        public static int GL_COLOR_ARRAY_TYPE_EXT = 0x8082;
        public static int GL_COLOR_ARRAY_STRIDE_EXT = 0x8083;
        public static int GL_COLOR_ARRAY_COUNT_EXT = 0x8084;
        public static int GL_INDEX_ARRAY_TYPE_EXT = 0x8085;
        public static int GL_INDEX_ARRAY_STRIDE_EXT = 0x8086;
        public static int GL_INDEX_ARRAY_COUNT_EXT = 0x8087;
        public static int GL_TEXTURE_COORD_ARRAY_SIZE_EXT = 0x8088;
        public static int GL_TEXTURE_COORD_ARRAY_TYPE_EXT = 0x8089;
        public static int GL_TEXTURE_COORD_ARRAY_STRIDE_EXT = 0x808A;
        public static int GL_TEXTURE_COORD_ARRAY_COUNT_EXT = 0x808B;
        public static int GL_EDGE_FLAG_ARRAY_STRIDE_EXT = 0x808C;
        public static int GL_EDGE_FLAG_ARRAY_COUNT_EXT = 0x808D;
        public static int GL_VERTEX_ARRAY_POINTER_EXT = 0x808E;
        public static int GL_NORMAL_ARRAY_POINTER_EXT = 0x808F;
        public static int GL_COLOR_ARRAY_POINTER_EXT = 0x8090;
        public static int GL_INDEX_ARRAY_POINTER_EXT = 0x8091;
        public static int GL_TEXTURE_COORD_ARRAY_POINTER_EXT = 0x8092;
        ...
        public static int GL_COLOR_TABLE_RED_SIZE_EXT = 0x80DA;
        public static int GL_COLOR_TABLE_GREEN_SIZE_EXT = 0x80DB;
        public static int GL_COLOR_TABLE_BLUE_SIZE_EXT = 0x80DC;
        public static int GL_COLOR_TABLE_ALPHA_SIZE_EXT = 0x80DD;
        public static int GL_COLOR_TABLE_LUMINANCE_SIZE_EXT = 0x80DE;
        public static int GL_COLOR_TABLE_INTENSITY_SIZE_EXT = 0x80DF;

        public static int GL_COLOR_INDEX1_EXT = 0x80E2;
        public static int GL_COLOR_INDEX2_EXT = 0x80E3;
        public static int GL_COLOR_INDEX4_EXT = 0x80E4;
        public static int GL_COLOR_INDEX8_EXT = 0x80E5;
        public static int GL_COLOR_INDEX12_EXT = 0x80E6;
        public static int GL_COLOR_INDEX16_EXT = 0x80E7;

        public static int GL_MAX_ELEMENTS_VERTICES_WIN = 0x80E8;
        public static int GL_MAX_ELEMENTS_INDICES_WIN = 0x80E9;

        public static int GL_PHONG_WIN = 0x80EA;
        public static int GL_PHONG_HINT_WIN = 0x80EB;
