...
namespace Qt.Gui {
    ...
    public class OpenGLFunctions : OpenGLConstants {
        ...
        public string glGetString(int name) {CPP.Add("std::shared_ptr<String> str = std::make_shared<String>((const char*)$q->glGetString((GLenum)name));"); return (string)CPP.ReturnObject("str");}
