...
namespace Qt.Gui {
    ...
    public class OpenGLFunctions : OpenGLConstants {
        ...
        public void glDrawElements(int mode, int count, int type) {CPP.Add("$q->glDrawElements(mode, count, type, (const GLvoid*)nullptr);");}
        ...
        public string glGetString(int name) {return CPP.ReturnString("Qt::Core::String::$new((const char*)$q->glGetString((GLenum)name))");}
